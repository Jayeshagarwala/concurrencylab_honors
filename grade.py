...
timeout_select_mixed_size1_size0 = 10 * timeout_multiplier
...
add_test_cases("test_stress_send_recv_size1", iters_one, timeout_stress_send_recv)
...
add_test_case_channel("test_stress_size1", iters_one, timeout_channel * 5)
add_test_case_sanitize("test_stress_size1", iters_one, timeout_sanitize * 5)
add_test_case_valgrind("test_stress_size1", iters_one, timeout_valgrind * 5)
...
all_final_tests = [key for key in test_cases]

# Honors tests
add_test_case_channel("test_size0", iters_slow)
add_test_case_sanitize("test_size0", iters_slow)
add_test_case_valgrind("test_size0", iters_slow, timeout_valgrind * 5)
add_test_case_channel("test_non_blocking_size0", iters_slow, timeout_channel * 3)
add_test_case_sanitize("test_non_blocking_size0", iters_slow, timeout_sanitize * 3)
add_test_case_valgrind("test_non_blocking_size0", iters_slow, timeout_valgrind * 3)
add_test_cases("test_stress_send_recv_size0", iters_one, timeout_stress_send_recv)
add_test_cases("test_select_and_non_blocking_send_size0", iters_slow)
add_test_cases("test_select_and_non_blocking_receive_size0", iters_slow)
add_test_cases("test_select_with_select_size0", iters_slow)
add_test_cases("test_select_with_same_channel_size0")
add_test_cases("test_select_with_send_receive_on_same_channel_size0")
add_test_cases("test_select_with_duplicate_channel_size0", iters_slow)
add_test_cases("test_select_mixed_size1_size0", iters_slow, timeout_select_mixed_size1_size0)
add_test_case_channel("test_stress_size0", iters_one, timeout_channel * 3)
add_test_case_sanitize("test_stress_size0", iters_one, timeout_sanitize * 3)
add_test_case_valgrind("test_stress_size0", iters_one, timeout_valgrind * 3)
add_test_case_channel("test_stress_mixed_size1_size0", iters_one, timeout_channel * 3)
add_test_case_sanitize("test_stress_mixed_size1_size0", iters_one, timeout_sanitize * 3)
add_test_case_valgrind("test_stress_mixed_size1_size0", iters_one, timeout_valgrind * 3)
...
point_breakdown_checkpoint = [
    ...
    (7, ["channel_test_stress_send_recv_size1"]),
    (7, ["sanitize_test_stress_send_recv_size1"]),
    (7, ["valgrind_test_stress_send_recv_size1"]),
...
point_breakdown_final = [
    ...
    (5, ["channel_test_stress_send_recv_size1"]),
    (5, ["sanitize_test_stress_send_recv_size1"]),
    (5, ["valgrind_test_stress_send_recv_size1"]),
    ...
    (15, ["channel_test_stress_size1"]),
    (15, ["sanitize_test_stress_size1"]),
    (15, ["valgrind_test_stress_size1"]),
...
point_breakdown_honors = [
    # Honors (100 pts)
    (1, ["make"]),
    (2, all_final_tests + ["channel_test_size0"]),
    (2, all_final_tests + ["sanitize_test_size0"]),
    (2, all_final_tests + ["valgrind_test_size0"]),
    (2, all_final_tests + ["channel_test_non_blocking_size0"]),
    (2, all_final_tests + ["sanitize_test_non_blocking_size0"]),
    (2, all_final_tests + ["valgrind_test_non_blocking_size0"]),
    (5, all_final_tests + ["channel_test_stress_send_recv_size0"]),
    (5, all_final_tests + ["sanitize_test_stress_send_recv_size0"]),
    (5, all_final_tests + ["valgrind_test_stress_send_recv_size0"]),

    (2, all_final_tests + ["channel_test_select_and_non_blocking_send_size0"]),
    (2, all_final_tests + ["sanitize_test_select_and_non_blocking_send_size0"]),
    (2, all_final_tests + ["valgrind_test_select_and_non_blocking_send_size0"]),
    (2, all_final_tests + ["channel_test_select_and_non_blocking_receive_size0"]),
    (2, all_final_tests + ["sanitize_test_select_and_non_blocking_receive_size0"]),
    (2, all_final_tests + ["valgrind_test_select_and_non_blocking_receive_size0"]),
    (2, all_final_tests + ["channel_test_select_with_select_size0"]),
    (2, all_final_tests + ["sanitize_test_select_with_select_size0"]),
    (2, all_final_tests + ["valgrind_test_select_with_select_size0"]),
    (2, all_final_tests + ["channel_test_select_with_same_channel_size0"]),
    (2, all_final_tests + ["sanitize_test_select_with_same_channel_size0"]),
    (2, all_final_tests + ["valgrind_test_select_with_same_channel_size0"]),
    (2, all_final_tests + ["channel_test_select_with_send_receive_on_same_channel_size0"]),
    (2, all_final_tests + ["sanitize_test_select_with_send_receive_on_same_channel_size0"]),
    (2, all_final_tests + ["valgrind_test_select_with_send_receive_on_same_channel_size0"]),
    (2, all_final_tests + ["channel_test_select_with_duplicate_channel_size0"]),
    (2, all_final_tests + ["sanitize_test_select_with_duplicate_channel_size0"]),
    (2, all_final_tests + ["valgrind_test_select_with_duplicate_channel_size0"]),
    (2, all_final_tests + ["channel_test_select_mixed_size1_size0"]),
    (2, all_final_tests + ["sanitize_test_select_mixed_size1_size0"]),
    (2, all_final_tests + ["valgrind_test_select_mixed_size1_size0"]),
    (5, all_final_tests + ["channel_test_stress_size0"]),
    (5, all_final_tests + ["sanitize_test_stress_size0"]),
    (5, all_final_tests + ["valgrind_test_stress_size0"]),
    (5, all_final_tests + ["channel_test_stress_mixed_size1_size0"]),
    (5, all_final_tests + ["sanitize_test_stress_mixed_size1_size0"]),
    (5, all_final_tests + ["valgrind_test_stress_mixed_size1_size0"]),
]
...
def grade():
    ...
    score_honors = 0
    total_possible_honors = 0
    for points, tests in point_breakdown_honors:
        if all(map(lambda test : test in result and result[test], tests)):
            score_honors += points
        total_possible_honors += points
    return (score_checkpoint, total_possible_checkpoint, score_final, total_possible_final, score_honors, total_possible_honors)

if __name__ == "__main__":
    score_checkpoint, total_possible_checkpoint, score_final, total_possible_final, score_honors, total_possible_honors = grade()
    print(f"Score: Checkpoint: {score_checkpoint} / {total_possible_checkpoint}, Final: {score_final} / {total_possible_final}, Honors: {score_honors} / {total_possible_honors}")
